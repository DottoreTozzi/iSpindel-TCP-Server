...
I am running the server in an ubuntu 16.04 container environement on my NAS. Most of the steps should also work on a raspberry. However, some steps may need to be adapted
...
Optionally for German keyboard you need to run these commands (this should work via raspi-config on the raspberry)
...
Endter a password for the datase user root during the configuration
