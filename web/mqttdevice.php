...
if (!$_GET['reset'])
{
 $DataAvailable=isDataAvailable($conn, $_GET['name'], $timeFrame);
  ...
  {
   $Header='MQTTDevice: ' . $header_no_data_1 . ' ' . $_GET['name']. ' ' . $header_no_data_2 . ' ' .$DataAvailable[1]. ' ' . $header_no_data_3;
  }
}
...
<head>
  ...
  <meta name="Keywords" content="MQTTDevice, Chart, genericTCP">
  <meta name="Description" content="MQTTDevice Chart">
